...
# Use only first 1k examples
train_images = mnist.train_images("mnist/")[:1000]
train_labels = mnist.train_labels("mnist/")[:1000]
test_images = mnist.test_images("mnist/")[:1000]
test_labels = mnist.test_labels("mnist/")[:1000]
